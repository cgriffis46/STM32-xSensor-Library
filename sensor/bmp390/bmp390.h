...
protected:
	...
	bool ReadReg8(bmp390_reg_t *_reg, bmp390_reg_addr_t addr);
	bool WriteReg8(bmp390_reg_t *_reg, bmp390_reg_addr_t addr);
	void ReadRegMulti(bmp390_reg_addr_t addr_t,uint8_t *buf,uint8_t numRegs);
	bool ReadCalData();
	bool Reset();
	bool ReadStatusReg();
	bool ReadEventReg();
