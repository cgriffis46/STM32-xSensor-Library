...
RTC_DS3231::RTC_DS3231(I2C_HandleTypeDef* _hi2c){
    this->hi2c = _hi2c;
}

bool RTC_DS3231::begin(uint8_t devAddress) {
  this->devAddress = devAddress<<1;
...
void RTC_DS3231::adjust(const DateTime &dt) {
  ...
  //i2c_dev->write(buffer, 8);
    ...
    HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,8,HAL_MAX_DELAY);
...
DateTime RTC_DS3231::now() {
  ...
  //i2c_dev->write_then_read(buffer, 1, buffer, 7);
    ...
    HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,1,HAL_MAX_DELAY);
    HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buffer,7,HAL_MAX_DELAY);
...
float RTC_DS3231::getTemperature() {
  ...
  //i2c_dev->write_then_read(buffer, 1, buffer, 2);
    ...
    //i2c_write_blocking(&this->i2c,this->devAddress,buffer,1,true);
    //i2c_read_blocking(&this->i2c,this->devAddress,buffer,2,false);

    HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,1,HAL_MAX_DELAY);
    HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buffer,2,HAL_MAX_DELAY);
...
bool RTC_DS3231::setAlarm1(const DateTime &dt, Ds3231Alarm1Mode alarm_mode) {
 ...
 // i2c_dev->write(buffer, 5);
  HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,5,HAL_MAX_DELAY);
    //i2c_write_blocking(&this->i2c,this->devAddress,buffer,5,true);
...
//  i2c_dev->write(buffer, 4);
    ...
    //i2c_write_blocking(&this->i2c,this->devAddress,buffer,4,true);
  HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,4,HAL_MAX_DELAY);
...
DateTime RTC_DS3231::getAlarm1() {
 ...
 //   i2c_read_blocking(&this->i2c,this->devAddress,buffer,5,false);
  HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,1,HAL_MAX_DELAY);
  HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buffer,5,HAL_MAX_DELAY);
...
DateTime RTC_DS3231::getAlarm2() {
  ...
  //i2c_dev->write_then_read(buffer, 1, buffer, 4);
    ...
    HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,buffer,1,HAL_MAX_DELAY);
    HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buffer,4,HAL_MAX_DELAY);
