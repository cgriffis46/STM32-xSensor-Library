...
RTC_DS1307::RTC_DS1307(I2C_HandleTypeDef* _hi2c){
this->hi2c = _hi2c;
}
...
*/
/**************************************************************************/
bool RTC_DS1307::begin(uint8_t devAddress) {
...
void RTC_DS1307::readnvram(uint8_t *buf, uint8_t size, uint8_t address) {
  ...
  //i2c_write_blocking(&this->i2c,this->devAddress,&addrByte,1,true);
  //i2c_read_blocking(&this->i2c,this->devAddress,buf,size,false);
  HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,&addrByte,1,HAL_MAX_DELAY);
  HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buf,size,HAL_MAX_DELAY);
}
...
void RTC_DS1307::writenvram(uint8_t address, uint8_t *buf, uint8_t size) {
  ...
  //i2c_dev->write(buf, size, true, &addrByte, 1);
    ...
    //i2c_write_blocking(&this->i2c,this->devAddress,&addrByte,1,true);
    //i2c_write_blocking(&this->i2c,this->devAddress,buf,size,true);
  HAL_I2C_Master_Transmit(this->hi2c,this->devAddress,&addrByte,1,HAL_MAX_DELAY);
  HAL_I2C_Master_Receive(this->hi2c,this->devAddress,buf,size,HAL_MAX_DELAY);
}
